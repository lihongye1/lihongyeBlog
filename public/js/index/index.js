...
// };
            ...
            function init() {
                ...
                $('.canvasAnimate').append(renderer.domElement);
            ...
            $('.shift-camera-button').click(function () {
                ...
                introTimeline.add([ TweenLite.to(skyContainer, 2, { opacity: 1, ease: Power3.easeInOut }),TweenLite.to(bottomContainer, 2, { opacity: 1, ease: Power3.easeInOut })]);
                skyContainer.show();
                setTimeout(function () {
                    $('.topNav,header').fadeIn('slow')
                },2000)
            });
